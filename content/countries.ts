...
// Generated from country-telephone-data (MIT). Flags are regional indicator
// symbols derived from the ISO code, so no images ship with them.
...
/** Pre-selected, since most enquiries come from here. */
