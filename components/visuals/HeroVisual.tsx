...
export function HeroVisual() {
  return (
    <div className="relative isolate h-full overflow-hidden rounded-[48px] bg-surface p-12 max-desk:h-[360px]">
      ...
      {/* Layer 1 — a heavily blurred triangle acting as a light beam. */}
      <div
        className="absolute -top-[335px] -right-[51px] z-[1] blur-[64px]"
        style={{ animation: "beam-drift 14s ease-in-out infinite" }}
      >
        <svg
          width={716}
          height={743}
      ...
      {/* Layer 4 — the portrait. */}
      <div className="mask-fade-b absolute bottom-[-54px] left-0 z-10">
        <Image
